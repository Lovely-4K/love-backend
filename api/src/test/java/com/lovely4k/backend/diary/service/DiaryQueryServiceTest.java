...
class DiaryQueryServiceTest extends IntegrationTestSupport {
    ...
    void findDiaryListInGrid() {
        ...
        // when
        DiaryListInGridResponse result = diaryQueryService.findDiaryListInGrid(BigDecimal.valueOf(38), BigDecimal.valueOf(127), BigDecimal.valueOf(36), BigDecimal.valueOf(126), 1L);
    ...
    void findDiaryListInGrid_Empty() {
        ...
        // when
        DiaryListInGridResponse result = diaryQueryService.findDiaryListInGrid(BigDecimal.valueOf(35), BigDecimal.valueOf(127), BigDecimal.valueOf(34), BigDecimal.valueOf(126), 1L);
